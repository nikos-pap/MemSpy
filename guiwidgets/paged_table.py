...
from PyQt6.QtWidgets import (
    ...
    QTableWidget, QTableWidgetItem, QLineEdit, QPushButton, QLabel, QCheckBox, QTableView
)
from PyQt6.QtCore import Qt, QSize

from model.search_table_model import SortedPagedTableModel
from utils import Type, RowEntry
from utils.types import convert_from_bytes, convert_to_bytes


class PaginatedTable(QWidget):
    def __init__(self, filter_command: Callable[[str], Dict[str, RowEntry]], change_value_command: Callable[[str, bytes], None], freeze_command: Callable[[str], None], data_signal, *args):
        super().__init__()
        ...
        data_signal.connect(self.model.handleUpdate)
