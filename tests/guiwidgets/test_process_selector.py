...
ps_mod = pytest.importorskip("guiwidgets.process_selector", reason="process_selector.py not importable")
ProcessSelectorBox = ps_mod.ProcessSelectorBox


@pytest.mark.gui
def test_emit_selection_signal(qtbot):
    combo = ProcessSelectorBox()
