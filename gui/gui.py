...
from guiwidgets import AddressTreeContainer, ScanControls, PaginatedTable
...
class MemoryScannerUI(QMainWindow):
    ...
    def __create_menu_bar(self):
        ...
        settings.triggered.connect(self.__open_settings)
        ...
        self.search_table_action.triggered.connect(
            lambda: self.search_table_dock.setVisible(self.search_table_action.isChecked()))
