...
class MemoryViewProcess(Process):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.address_manager = AddressManager(self.process_reader)
    ...
    def freeze_address(self, address: int, value: bytes) -> None:
        self.address_manager.freeze_address(address, value)
        # if not self.process_reader:
        #     return
        # data_read = self.process_reader.read_bytes(address, 4)
        # if data_read is not None and value is not None:
    ...
    def unfreeze_address(self, address: int) -> None:
        ...
        self.address_manager.unfreeze_address(address)

    def add_saved_address(self, address: int) -> None:
        self.address_manager.add_saved_address(address)
    ...
    def remove_saved_address(self, address: int) -> None:
        self.address_manager.remove_saved_address(address)
    ...
    def set_value(self, address: int, value: bytes) -> None:
        self.address_manager.set_value(address, value)
